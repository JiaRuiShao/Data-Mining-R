...
hist(wine$quality , breaks =5, col ="grey", xlab ="Quality ",xlim=c(0,10),main="Histogram of Quality Wine")
...
cv.model=cv.tree(tree.model,K=10,FUN=prune.misclass) #indicate it's classification
cv.model
...
#we use the pruned tree to make predictions in the testing set and 
