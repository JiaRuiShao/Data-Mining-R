...
hist(wine$quality , breaks =5, col ="gray", xlab ="Quality ",xlim=c(0,10),main="Histogram of Quality Wine")
...
plot(quality , alcohol, col ="gray",varwidth =T, xlab="Quality",ylab ="Alcohol ", main="Quality vs Alcohol", cex.main=1.5)
plot(quality , sulphates, col ="gray",varwidth =T, xlab="Quality",ylab ="Sulphates ", main="Quality vs Sulphates", cex.main=1.5)
plot(quality , volatile.acidity, col ="gray",varwidth =T, xlab="Quality",ylab ="Volatile Acidity ", main="Quality vs Volatile Acidity", cex.main=1.5)

plot(quality , density, col ="gray",varwidth =T, xlab="Quality",ylab ="Density ", main="Quality vs Density", cex.main=1.5)
plot(quality , citric.acid, col ="gray",varwidth =T, xlab="Quality",ylab ="Citric Acid ", main="Quality vs Citric Acid", cex.main=1.5)
plot(quality , fixed.acidity, col ="gray",varwidth =T, xlab="Quality",ylab ="Fixed Acidity ", main="Quality vs Fixed Acitidy", cex.main=1.5)
plot(quality , total.sulfur.dioxide, col ="gray",varwidth =T, xlab="Quality",ylab ="Citric Acid ", main="Quality vs Citric Acid", cex.main=1.5)

# variables that have no affect on response
plot(quality , free.sulfur.dioxide, col ="gray",varwidth =T, xlab="Quality",ylab ="Free Sulfur Dioxide", main="Quality vs Free Sulfur Dioxide", cex.main=1.5)
plot(quality , pH, col ="gray",varwidth =T, xlab="Quality",ylab ="pH ", main="Quality vs pH", cex.main=1.5)
plot(quality , residual.sugar, col ="gray",varwidth =T, xlab="Quality",ylab ="Residual Sugar ", main="Quality vs Residual Sugar", cex.main=1.5)
plot(quality , chlorides, col ="red",varwidth =T, xlab="Quality",ylab ="Chlorides ", main="Quality vs Chlorides", cex.main=1.5)


#final boxplots for report with potential predictors
par(mfrow=c(1,3))
plot(quality , alcohol, col ="red",varwidth =T, xlab="Quality",ylab ="Alcohol ", main="Quality vs Alcohol", cex.main=1.5)
plot(quality , volatile.acidity, col ="red",varwidth =T, xlab="Quality",ylab ="Volatile Acidity ", main="Quality vs Volatile Acidity", cex.main=1.5)
plot(quality , sulphates, col ="red",varwidth =T, xlab="Quality",ylab ="Sulphates ", main="Quality vs Sulphates", cex.main=1.5)

#final boxplots for report with predictors who has no effect

par(mfrow=c(1,3))
plot(quality , free.sulfur.dioxide, col ="red",varwidth =T, xlab="Quality",ylab ="Free Sulfur Dioxide", main="Quality vs Free Sulfur Dioxide", cex.main=1.5)
plot(quality , pH, col ="red",varwidth =T, xlab="Quality",ylab ="pH ", main="Quality vs pH", cex.main=1.5)
plot(quality , residual.sugar, col ="red",varwidth =T, xlab="Quality",ylab ="Residual Sugar ", main="Quality vs Residual Sugar", cex.main=1.5)
...
summary(glm.fit) 
coef(glm.fit)      
#### not sure about if we need this  summary(glm.fit)$coef
...
mean(glm.pred2==test.truevalue) #accuracy 89.69%
mean(glm.pred2!=test.truevalue)

#5-fold cross-validation prediction of the model
k=5
